...
export abstract class InventoryTransactionRepository {
  abstract create(
  ...
  ): Promise<NullableType<InventoryTransaction>>;

  // abstract findByIds(
  //   ids: InventoryTransaction['id'][],
  // ): Promise<InventoryTransaction[]>;

  abstract update(
    id: InventoryTransaction['id'],
    payload: DeepPartial<InventoryTransaction>,
