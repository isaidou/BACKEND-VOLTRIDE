...
exports.IncidentsModule = IncidentsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            relational_persistence_module_1.RelationalIncidentPersistenceModule,
        ],
        controllers: [incidents_controller_1.IncidentsController],
        providers: [incidents_service_1.IncidentsService],
        exports: [incidents_service_1.IncidentsService, relational_persistence_module_1.RelationalIncidentPersistenceModule],
    })
], IncidentsModule);
