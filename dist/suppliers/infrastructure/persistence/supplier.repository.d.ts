...
export declare abstract class SupplierRepository {
    abstract create(data: Omit<Supplier, 'id' | 'createdAt' | 'updatedAt'>): Promise<Supplier>;
    ...
    abstract update(id: Supplier['id'], payload: DeepPartial<Supplier>): Promise<Supplier | null>;
