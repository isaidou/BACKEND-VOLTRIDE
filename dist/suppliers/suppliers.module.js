...
exports.SuppliersModule = SuppliersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            relational_persistence_module_1.RelationalSupplierPersistenceModule,
        ],
        controllers: [suppliers_controller_1.SuppliersController],
        providers: [suppliers_service_1.SuppliersService],
        exports: [suppliers_service_1.SuppliersService, relational_persistence_module_1.RelationalSupplierPersistenceModule],
    })
], SuppliersModule);
