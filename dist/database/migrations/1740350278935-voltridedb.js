...
exports.Voltridedb1740350278935 = void 0;
class Voltridedb1740350278935 {
    constructor() {
        this.name = 'Voltridedb1740350278935';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "maintenance_parts" ("maintenance_id" uuid NOT NULL, "part_id" uuid NOT NULL, "quantityUsed" integer NOT NULL DEFAULT '1', "cost" numeric(10,2), CONSTRAINT "PK_8806d36f294f6bbbc2211933035" PRIMARY KEY ("maintenance_id", "part_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "purchase_order_line" ADD CONSTRAINT "FK_5d8c68b77890a17d89746f2f861" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_order"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "maintenance_parts" ADD CONSTRAINT "FK_28a44e71f0a005a36c186a306ed" FOREIGN KEY ("maintenance_id") REFERENCES "maintenance"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "maintenance_parts" ADD CONSTRAINT "FK_1bed423a68d378e0771ef56496d" FOREIGN KEY ("part_id") REFERENCES "part"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "maintenance_parts" DROP CONSTRAINT "FK_1bed423a68d378e0771ef56496d"`);
        await queryRunner.query(`ALTER TABLE "maintenance_parts" DROP CONSTRAINT "FK_28a44e71f0a005a36c186a306ed"`);
        await queryRunner.query(`ALTER TABLE "purchase_order_line" DROP CONSTRAINT "FK_5d8c68b77890a17d89746f2f861"`);
...
exports.Voltridedb1740350278935 = Voltridedb1740350278935;
//# sourceMappingURL=1740350278935-voltridedb.js.map